    ...
    <div class="container-fluid">
        ...
        <div class="row card  shadow">
            <div class="card-header ">
                <h3 class="text-gray-600 display-7">Ajouter corp</h3>
            </div>


    <!-- ////////////////////////////// form start ///////////////////////////////// -->
    <form class="add" method="POST" action=" {{route("corps.store")}} " >
      @csrf   
                        ...
                        <div class="card-body ">
                            ...
                            --}}
                                   ...
                                   <center> <button class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" type="submit">&nbsp;Ajouter corp</button></center>
