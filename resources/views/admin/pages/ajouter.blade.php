                                    ...
                                    <div class="row">
                                        ...
                                        <div style="min-width: 30%;" class="col">
                                            <div  class="has-float-label mb-4"><label class="form-label" ><strong>Prenom</strong></label>
                                              <input class="form-control" type="text"  placeholder="Prénom" name="prenom"></div>
                                    ...
                                    <div class="row">
                                        <div style="min-width: 30%;" class="col">
                                            <div class="has-float-label mb-4"><label class="form-label" ><strong>CIN</strong></label>
                                              <input class="form-control" type="text"  placeholder="CIN" name="cin"></div>
                                        ...
                                        <div class="col">
                                            <div class="has-float-label mb-4"><label class="form-label" ><strong>Date de naissance </strong></label>
                                              <input class="form-control" type="date" name="date_naissance"></div>
                                        ...
                                        <div class="col">
                                            <div class="has-float-label mb-4"><label class="form-label" ><strong>lieu de naissance</strong></label>
                                              <input style="margin-right: 100px;" class="form-control" type="text"  placeholder="lieu_naissance" name="lieu_naissance">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="has-float-label mb-4"><label class="form-label" ><strong>Tel</strong></label>
                                              <input class="form-control" type="number"  placeholder="Tel" name="tel"></div>
                                            ...
                                            <div class="has-float-label mb-4"><label class="form-label" ><strong>Sexe</strong></label>
                                                <div class="form-control sexe_global_input" >
                                                    <div class="input_group">
                                                        <input type="radio" id="hh" name="sexe" value="1"  @if(old('sexe') == '1') checked @endif required>
                                                        <span class="sexe_label" for="hh">Femme</span>
                                                    </div>
                                                    <div class="input_group">
                                                        <input type="radio" id="mm" name="sexe" value="0"  @if(old('sexe') == '0') checked @endif required>
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="col">
                                                        <div class="has-float-label mb-4">
                                                            ...
                                                            <input class="form-control" type="date" name="date_ambauche">
                                                    ...
                                                    <div style="min-width: 30%;" class="col">
                                                        <div class="has-float-label mb-4">
                                                            ...
                                                            <select class="form-control" name="situation_familial" id="">
                                                    ...
                                                    <div style="min-width: 30%;" class="col">
                                                        <div class="has-float-label mb-4">
                                                            ...
                                                            <input class="form-control" type="number" name="Nbr_enfants" placeholder="N° d'enfants">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div style="min-width: 30%;" class="col">
                                                    <div class="has-float-label mb-4">
                                                        ...
                                                        <select class="form-control" name="indice_id" id="">
